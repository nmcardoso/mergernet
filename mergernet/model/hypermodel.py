...
class BayesianTuner(kt.BayesianOptimization):
  def run_trial(self, trial, *kargs, **kwargs):
    ...
    return sm.fit(
      ...
      dropout_rate_1=hp.Choice('dropout_1_rate', [0.2, 0.3, 0.4, 0.5]),
      dense_2=hp.Boolean('dense_2'),
      dense_units_2=hp.Choice('dense_2_units', [128, 256, 512], parent='dense_2', parent_values=[True]),
      dropout_2=hp.Boolean('dropout_2', parent='dense_2', parent_values=[True]),
      dropout_rate_2=hp.Choice('dropout_2_rate', [0.2, 0.3, 0.4, 0.5], parent='dropout_2', parent_values=[True]),
      dense_3=hp.Boolean('dense_3', parent='dense_2', parent_values=[True]),
      dense_units_3=hp.Choice('dense_3_units', [64, 128, 256, 512], parent='dense_3', parent_values=[True]),
